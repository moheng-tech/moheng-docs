...
**请求URL：** - ``http://localhost:3001/uploadWithWholeLocal``
...
参数名 必选 类型   说明
=========== ==== ====== ========================
uploadFile  是   number from表单提交，file字段名
=========== ==== ====== ========================
...
::

    {
       ...
       "statusCode": 200,
       "message": null,
       "data": "f87c04808504a817c8008203e8944cd3d4075200ef5bd9f65ce7360b5642e8ca09a701800294.png"
   }
...
**请求URL：** - ``http://localhost:3001/downloadWithWholeLocal``
